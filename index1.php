...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(left, rgb(141, 141, 227), rgb(242, 214, 214)); background-size: cover;">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">

      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp AMU Clinic</h4></a>
            ...
            <div class="card-body">
              ...
              <form class="form-group" method="POST" action="func.php">
                <div class="row" style="margin-top: 10%">
                  ...
                  <div class="col-md-8"><input type="text" name="idc" class="form-control" placeholder="Enter ID number" required/></div><br><br>
                ...
                <div class="row">
                 <div class="col-md-4"  style="padding-left: 160px;margin-top: 10%">
                    <center><input type="submit" id="inputbtn" name="patsub" value="Login" class="btn btn-primary" style="background: -webkit-linear-gradient(left, rgb(141, 141, 227), rgb(242, 214, 214)); border: none;"></center></div>           
