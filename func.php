...
if(isset($_POST['patsub'])){
	...
	$query="select * from patreg where idc='$idc' and password='$password';";
...
if(isset($_POST['doc_sub']))
{
  ...
  $docFees=$_POST['docFees'];
	$query="insert into doctb(username,password,idc,docFees)values('$doctor','$dpassword','$didc','$docFees')";
	$result=mysqli_query($con,$query);
	if($result)
            ...
            <div class="card-body">
              ...
              <form class="form-group" method="post" action="appointment.php">
                <div class="row">
                  ...
                  <div class="col-md-8"><input type="text"  class="form-control" name="idc"></div><br><br>
