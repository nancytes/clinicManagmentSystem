              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    $query = "select pid,ID,fname,lname,gender,idc,contact,appdate,apptime,userStatus,doctorStatus from appointmenttb where doctor='$dname';";
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          <div class="row">
                  ...
                  <div class="col-md-4"><label>idc ID:</label></div>
