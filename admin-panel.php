    ...
    if((date("Y-m-d",$appdate1)==$cur_date and date("H:i:s",$apptime1)>$cur_time) or date("Y-m-d",$appdate1)>$cur_date) {
      $check_query = mysqli_query($con,"select apptime from appointmenttb where doctor='$doctor' and appdate='$appdate' and apptime='$apptime'");
        ...
        if(mysqli_num_rows($check_query)==0){
          $query = mysqli_query($con, "INSERT INTO appointmenttb (pid, fname, lname, gender, idc, contact, doctor, appdate, apptime, userStatus, doctorStatus) VALUES ('$pid', '$fname', '$lname', '$gender', '$idc', '$contact', '$doctor', '$appdate', '$apptime', '1', '1')");
...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css?family=IBM+Plex+Sans&display=swap" rel="stylesheet">
      <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" style="background: -webkit-linear-gradient(left, rgb(141, 141, 227), rgb(242, 214, 214));">
